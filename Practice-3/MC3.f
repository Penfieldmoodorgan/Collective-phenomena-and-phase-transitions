...
c simular model dIsing 2D. 
      ...
      program practica 
      implicit none
      integer*4 seed0,nseed,l,i,j,k,imc,ipas,mcd,mcini,seed,c
      parameter(l=32)
      integer*4 pbc(0:l+1)
      integer*2 s(1:l,1:l), de1
      integer*8 suma,de,mctot,n
      real*8 mag,magne,genrand_real2,ene,energ,enebis
      real*8 sum,sume,sume2,summ,summ2,sumam,vare,varm,temp
      real*8 w(-8:8)
      character*29 nom,f1,f2,f3,f4,f5,f11,f12,f13,f14,f15
      character*29 fitxer(1:5),fit1(1:5)
...
c construim array per als noms dels fitxers en funció de T 
      ...
      f1="SIM-L-032-TEMP-1500-MCTOT-10K"
      f2="SIM-L-032-TEMP-1800-MCTOT-10K"
      f3="SIM-L-032-TEMP-2500-MCTOT-10K"
      f4="SIM-L-032-TEMP-3500-MCTOT-10K"
      f5="SIM-L-032-TEMP-4500-MCTOT-10K"

      fitxer=[f1,f2,f3,f4,f5]

      f11="MC-L-032-TEMP-1500"
      f12="MC-L-032-TEMP-1800"
      f13="MC-L-032-TEMP-2500"
      f14="MC-L-032-TEMP-3500"
      f15="MC-L-032-TEMP-4500"

      fit1=[f11,f12,f13,f14,f15]
...
c Bucle per a una passa de mc
                        ...
                        if ((imc.gt.mcini).and.(mcd*(imc/mcd).eq.imc)) 
     +then
                              mag=magne(s,l)
                              sum=sum+1.0d0
                              sume=sume+ene
