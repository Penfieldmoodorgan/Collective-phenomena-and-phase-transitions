c pràctica 1 fenòmens- genera 50000 nombres uniformes a partir de una 
c llavor i els treu per pantalla. Calcula la mitjana i la desviació 
c típica dels nombres generats.

      program practica
      implicit none
      integer SEED, i, NRAND
      real*8 x, mean, a, sigma, genrand_real2
      ...
      mean=mean/real(NRAND)    
      a=a/real(NRAND)  
      sigma=dsqrt(a-mean*mean)


      write(*,*) "mitjana:", mean, "desviacio:", sigma
